# Task
The task is to build a one (optional 2) model domain with the CRUD functionality (RESTful routes), and have a JavaScript client to access you backend.

Feel free to use boilerplate to set up the file structure of the HTML and JS files from previous labs or assignments.

Work iteratively, and be able to fetch and display the index of the model aka @models = Model.all (seed your data) on the page. 
The following steps should be to be able to create/new, and then after that, feel free to attempt edit/update/delete.
